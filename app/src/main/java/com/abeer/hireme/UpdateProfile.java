...
public class UpdateProfile extends AppCompatActivity {
    ...
    private EditText nameUpdate,emailUpdate,phoneUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        photoUpdate = findViewById(R.id.imageViewupdate);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                nameUpdate.setText(userProfile.getUserName());
                emailUpdate.setText(userProfile.getUserEmail());
                phoneUpdate.setText(userProfile.getUserPhone());
        ...
        storageReference.child(firebaseAuth.getUid()).child("Images/Profile Pic").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                //picasso code
                Picasso.get().load(uri).fit().centerCrop().into(photoUpdate);
            }
        });
        ...
        photoUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
